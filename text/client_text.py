...
zakus = [
    "добротным куском копченого сала",
    "большим кислым огурцом",
    "снежком",
    ", нет, занюхнул россола да так что аж глаза наверх лоба полезли",
    "найденым у кладовке вишневым вареньем",
    "помидоркой с бочки",
    "\n нет, такое дело не закусуют",
    "мазанкой с маслом и шпротами",
    "черствым куском хлеба",
    "жареным карасиком",
    ]
